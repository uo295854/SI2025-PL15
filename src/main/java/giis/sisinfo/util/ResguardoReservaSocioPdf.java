...
public class ResguardoReservaSocioPdf {

    public String generar(ResguardoReservaSocioDTO r) throws IOException {
        ...
        try (PDDocument doc = new PDDocument()) {
            ...
            try (PDPageContentStream cs = new PDPageContentStream(doc, page)) {
                ...
                cs.newLineAtOffset(0, -15);
                cs.showText("Fecha: " + r.getFecha().format(fmtFecha));
                cs.newLineAtOffset(0, -15);
                cs.showText("Horas: " + formatearHoras(r));
                cs.newLineAtOffset(0, -15);
                cs.showText(String.format("Cuota: %.2f €", r.getCuota()));
                ...
                cs.newLineAtOffset(0, -20);
                cs.showText("Resguardo emitido el: " + r.getFechaEmision().format(fmtFecha));
    ...
    private String formatearHoras(ResguardoReservaSocioDTO r) {
