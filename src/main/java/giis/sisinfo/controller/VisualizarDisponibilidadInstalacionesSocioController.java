...
public class VisualizarDisponibilidadInstalacionesSocioController {

	private final VisualizarDisponibilidadInstalacionesSocioModel model;
	private final VisualizarDisponibilidadInstalacionesSocioView view;
	...
	public VisualizarDisponibilidadInstalacionesSocioController(VisualizarDisponibilidadInstalacionesSocioModel model, VisualizarDisponibilidadInstalacionesSocioView view, int idSocioActual ) {
		this.model = model;
		this.view = view;
	...
	private void onInstalacionSeleccionada() {
	 ...
	 private void onSeleccionDia(ListSelectionEvent e) {
	        ...
	        if ("NO RESERVABLE".equalsIgnoreCase(estado)) {
	            limpiarTodo(view.gettablaHoras());
	            diaSeleccionado = null;
	            return;
	        }
	        ...
	        List<HoraReservaSocioDTO> horas = model.getHorasDia(idInstalacionSeleccionada, diaSeleccionado, idSocioActual);
	        DefaultTableModel th = (DefaultTableModel) view.gettablaHoras().getModel();
	        limpiarTodo(view.gettablaHoras());

	        for (HoraReservaSocioDTO h : horas) {
	            th.addRow(new Object[]{ h.getHoraInicio(), h.getEstado()});
	        }
